...
";
        ...
        static Tuple<Function, Variable> GetModel()
        {
            ...
            var n = Layers.Dense(input, new int[] { 100 }, CNTKLib.HeNormalInitializer(), true, CNTKLib.ConstantInitializer(0), "relu", "");
            var output = Layers.Dense(n, new int[] { 2 }, CNTKLib.GlorotNormalInitializer(), true, CNTKLib.ConstantInitializer(0), "sigmoid", "");
